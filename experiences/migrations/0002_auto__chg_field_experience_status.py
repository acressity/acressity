...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experience.status'
        db.alter_column(u'experiences_experience', 'status', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Experience.status'
        db.alter_column(u'experiences_experience', 'status', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
