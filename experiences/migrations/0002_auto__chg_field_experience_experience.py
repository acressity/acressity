...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Experience.experience'
        db.alter_column(u'experiences_experience', 'experience', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Experience.experience'
        db.alter_column(u'experiences_experience', 'experience', self.gf('django.db.models.fields.CharField')(max_length=210))
