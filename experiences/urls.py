...
urlpatterns = patterns(
    'experiences.views',
    url(r'^$', ListView.as_view(queryset=Experience.objects.exclude(is_public=False), context_object_name='all_public_experiences', template_name='experiences/all.html', paginate_by=10), name="all_experiences"),
    ...
    url(r'^freshest/$', ListView.as_view(queryset=Experience.objects.exclude(is_public=False).order_by('-date_created'), context_object_name='freshest_experiences', template_name='experiences/freshest.html', paginate_by=10), name="freshest_experiences"),
    url(r'^random/$', ListView.as_view(queryset=Experience.objects.exclude(is_public=False).order_by('?'), context_object_name='random_experiences', template_name='experiences/random.html'), name="random_experiences"),
