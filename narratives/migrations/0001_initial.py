    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='Title of the narrative. If none given, defaults to date created.', max_length=200, null=True, blank=True)),
                ('date_created', models.DateTimeField(default=datetime.datetime.now, blank=True)),
                ('date_modified', models.DateTimeField(help_text=b'Updated every time object saved', auto_now=True)),
