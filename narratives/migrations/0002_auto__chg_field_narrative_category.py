...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Narrative.category'
        db.alter_column(u'narratives_narrative', 'category', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Narrative.category'
        db.alter_column(u'narratives_narrative', 'category', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
