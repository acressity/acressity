...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Explorer.trailname'
        db.alter_column(u'explorers_explorer', 'trailname', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Explorer.trailname'
        db.alter_column(u'explorers_explorer', 'trailname', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
