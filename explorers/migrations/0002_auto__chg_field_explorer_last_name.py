...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Explorer.last_name'
        db.alter_column(u'explorers_explorer', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Explorer.last_name'
        db.alter_column(u'explorers_explorer', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=50))
