...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cheer'
        db.create_table(u'support_cheer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cheerer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cheers_from', to=orm['explorers.Explorer'])),
            ('explorer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cheers_for', to=orm['explorers.Explorer'])),
            ('date_cheered', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'support', ['Cheer'])

        # Adding model 'Hurrah'
        db.create_table(u'support_hurrah', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('explorer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['explorers.Explorer'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='content_type_set_for_hurrah', to=orm['contenttypes.ContentType'])),
            ('object_pk', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'support', ['Hurrah'])


    def backwards(self, orm):
        # Deleting model 'Cheer'
        db.delete_table(u'support_cheer')

        # Deleting model 'Hurrah'
        db.delete_table(u'support_hurrah')
