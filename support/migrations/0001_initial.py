    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_cheered', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text=b'This information is used responsibly. It will only be used to send an invitation request and create their profile should they choose to join.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Quote',
            fields=[
                ...
                ('category', models.CharField(default=b'motivational', max_length=20, choices=[(b'motivational', b'motivational'), (b'inspirational', b'inspirational')])),
            ],
        ),
        migrations.AddField(
